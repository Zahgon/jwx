...
func RegisterKeyParser(kp KeyParser) error { _ = "STUB: not implemented"; return nil }
...
func RegisterProbeField[T any](name, jsonKey string) error { _ = "STUB: not implemented"; return nil }
